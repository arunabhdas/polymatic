    ...
    <aside className="w-56 flex-shrink-0 flex flex-col bg-background text-foreground">
      ...
      <div className="flex-1 overflow-y-auto py-3 px-2 flex flex-col gap-5">
        <div className="flex flex-col gap-0.5">
          <NavItem icon={<Home size={16} />} label="Home" to="/" active={location.pathname === "/"} />
          <NavItem icon={<Search size={16} />} label="Search" shortcut="⌘K" to="/search" active={location.pathname === "/search"} />
          <NavItem icon={<TrendingUp size={16} />} label="Trends" to="/trends" active={location.pathname === "/trends"} />
          <NavItem icon={<BarChart2 size={16} />} label="Markets" to="/markets" active={location.pathname === "/markets"} />
          <NavItem icon={<Globe size={16} />} label="Geo View" to="/geo" active={location.pathname === "/geo"} />
        </div>
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <NavItem icon={<span className="size-2 rounded-full bg-blue-500" />} label="Nvidia Earnings" to="/markets/nvda" active={false} />
          <NavItem icon={<span className="size-2 rounded-full bg-orange-500" />} label="OpenAI DevDay" to="/events/openai" active={false} />
          <NavItem icon={<span className="size-2 rounded-full bg-purple-500" />} label="Federal Reserve" to="/macro/fed" active={false} />
        </div>
      </div>

      {/* Footer */}
      <div className="p-2 border-t border-border">
        <NavItem icon={<Settings size={16} />} label="Settings" to="/settings" active={location.pathname === "/settings"} />
