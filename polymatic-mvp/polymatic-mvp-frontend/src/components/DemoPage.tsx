...
import { C, FONT, landingCSS, TickerBar, TopNav, FeaturesStrip, StepsSection, Dot } from './LandingPage';
      ...
      <div style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: FONT.sans }}>
        ...
        <div style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            padding: '6px 14px', borderRadius: 20, backdropFilter: 'blur(8px)',
          }}>
          ...
          {/* Headline overlay */}
          <div style={{
            position: 'absolute', bottom: 60, left: 40, zIndex: 20,
            maxWidth: 520, pointerEvents: 'none',
          }}>
            <h1 style={{ fontFamily: FONT.serif, fontSize: 48, fontWeight: 900, lineHeight: 1.05, color: C.text, marginBottom: 10, textShadow: '0 2px 20px rgba(0,0,0,0.7)' }}>
