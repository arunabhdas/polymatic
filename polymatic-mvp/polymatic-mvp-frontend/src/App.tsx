...
export default function App() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-black font-sans">
      ...
      {/* Event feed toggle — mobile only, top-right */}
      {!eventFeedOpen && (
        <button
          onClick={() => setEventFeedOpen(true)}
          className="fixed bottom-4 right-4 z-20 md:hidden p-2 rounded-lg bg-zinc-950/80 border border-zinc-800 backdrop-blur-sm text-zinc-300 hover:text-white hover:bg-zinc-900 transition-colors"
